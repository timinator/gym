...
User.delete_all
a = User.create(name: 'Thomas', email: 'thomas@a.com', password: '1', password_confirmation: '1', gender: 'male', workout_goal: 'weights', phone: '6469208813')
b = User.create(name: 'Aaron', email: 'aaron@a.com', password: '1', password_confirmation: '1', gender: 'male', workout_goal: 'cardio', phone: '2037479716')
c = User.create(name: 'Zahra', email: 'zahra@a.com', password: '1', password_confirmation: '1', gender: 'female', workout_goal: 'toning', phone: '6462094745')
